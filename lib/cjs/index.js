...
// index.ts
var mostrodk_exports = {};
__export(mostrodk_exports, {
  mostro: () => mostro_exports,
  mostroClient: () => client_exports,
  mostroCore: () => core_exports
});
module.exports = __toCommonJS(mostrodk_exports);
